...
public class KakaoRestApiHelper {
    ...
    public ResponseEntity<String> getSearchPlaceByKeyword(AreaDto area) throws Exception {
        String queryString = "?query="+URLEncoder.encode(area.getKeyword(), "UTF-8")+"&page="+area.getCurrentPage()+"&size="+area.getPageSize();
